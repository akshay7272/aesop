...
export default function FirstSection() {
  return (
    <>
      <section class="container-fluid mx-auto px-4 background-image">
        <h1 class="Logo_wrapper__hdqNp Logo_desktop__jWvZh">
          <a
          ...
          >
            ...
            >
              <title aria-label="Aesop logo" id="aesop-267">
                Aesop
              </title>
              <g>
        ...
        <div>
          <div class="Banner-content">
            <div class="Banner HeroBannerContent_innerWrapper__yhIPj">
              <header
                class="flex relative flex-col HeroBannerContent_header__4Ls0S SectionHeading_base__WfOsV SectionHeading_heroHeading__2llNV"
                data-testid="data-testid-SectionHeading"
              >
                <h2 class="base-heading Heading_base__RCdQN Heading_xLarge__AY5lq Heading_light__G2Y3e SectionHeading_heading__vDzj6">
                  Othertopias: a collection of unorthodox fragrances
                </h2>
                <h3 class="heading-base Heading_base__RCdQN Heading_mediumWeightFont__L_H2X Heading_xXSmall__4OioP Heading_light__G2Y3e SectionHeading_eyebrow__U4VKb">
                  Doorways to the undiscovered
                </h3>
              </header>
              <div class="HeroBannerContent_content__9uokW">
                <div class="paragraph-div Paragraph_set__4eh2O Paragraph_light__GdrHW Paragraph_large__sLV_o HeroBannerContent_description__J3n4G">
                  <p class="Paragraph_base__CFztu Paragraph_light__GdrHW Contentful_contentful__richtext--whitespace__p8_HS">
                ...
                <div
                  ...
                  data-testid="data-testid-LinkButtonGroup"
                >
                  <a
                    class="Hyperlink_base Hyperlink_base__H3jim Hyperlink_blockStyle__yQb3f Hyperlink_hasIcon__9Sbrv Hyperlink_left__UZaMy Hyperlink_light__12A_f  LinkButtonGroup_link__8p_Gr LinkButtonGroup_flushLink__ATBft"
                    href="/hk/en/r/othertopias-fragrances/"
                    target="_self"
                  >
                    Discover the fragrances{" "}
                    <i aria-hidden="true" class="Hyperlink_icon__u_gO9">
                      <svg
                        aria-labelledby="rightArrow-2518"
                        ...
                        width="12"
                      >
                        <title id="rightArrow-2518">rightArrow</title>
                        <g>
